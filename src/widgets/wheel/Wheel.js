...
import {StyleSheet, View, Text, Animated, PanResponder, ViewPropTypes,PixelRatio} from 'react-native';
...
export default class Wheel extends Component {
  ...
  buildProps() {
    ...
    if (holeLine === undefined) {
        holeLine = <View style={{alignItems:'center',justifyContent:'center'}}><View style={{height: Theme.wheelHoleLineWidth,width:100, backgroundColor: Theme.wheelHoleLineColor}} /></View>;
    } else if (typeof holeLine === 'number') {
      holeLine = <View style={{alignItems:'center',justifyContent:'center'}}><View style={{height: holeLine,width:100,backgroundColor: Theme.wheelHoleLineColor}} /></View>;
    }
